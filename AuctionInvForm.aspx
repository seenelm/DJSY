<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuctionInvForm.aspx.cs" Inherits="WebFormDesign.AuctionInvForm" %>
    ...
    <form id="form1" runat="server">
        <div>
            <fieldset style="width: 1245px; height: 415px">
                <legend>Auction Inventory</legend>
                <asp:Table ID="InvAuctionTable" runat="server" Width="59%" Height="400px">
                    <asp:TableRow>
                        <asp:TableCell>
